...
public class RiskAssessmentScheduleController {
    ...
    @RequestMapping(value = "/submitRiskAssessmentSchedule", consumes = "application/json", produces = "application/json")
    public RiskAssessmentSchedule submitRiskAssessmentSchedule(@RequestBody SubmitRiskAssessmentScheduleInput requestBody) {
        LOGGER.info(requestBody.toString());
        return riskAssessmentScheduleService.submitRiskAssessmentSchedule(requestBody);
    }
}
